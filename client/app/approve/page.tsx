...
const DeviceApprovalPage = () => {
  ...
  const handleApprove = async ()=>{
    ...
    try {
        ...
        toast.success("Device approved succesfully")
        router.push("/")
    } catch (error) {
            ...
            <div className="space-y-8">
                <div className="border-2 border-dashed border-zinc-700 rounded-2xl p-8 bg-zinc-900/50 backdrop-blur-sm text-center">
                    ...
                    <div className="space-y-3">
                        <h1 className="text-2xl font-bold text-zinc-50">Device Authorization</h1>
                        <p className="text-sm text-zinc-400">A new device is requesting access to you'r account</p>
                    </div>
                </div>
                <div className="border-2 border-dashed border-zinc-700 rounded-2xl p-6 bg-zinc-900/50 backdrop-blur-sm space-y-4">
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-zinc-600 text-center">Share this code with the requesting</p>
                    </div>
                </div>
                <div className="border-2 border-dashed border-zinc-700 rounded-2xl p-6 bg-zinc-900/50 backdrop-blur-sm">
                    <div className="space-y-3">
                        ...
                        <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
                            <p>Only approve this request if you initiated it. For security, never share this code with others.</p>
                        </div>
                    </div>
                </div>
                <div className="space-y-3">
                    <Button
                        className="w-full h-11 bg-emerald-600 hover:bg-emeral-700 text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"
